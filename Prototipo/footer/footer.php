...
<footer class="bg-dark text-white py-5" style="font-family: 'Nunito', sans-serif;">
  <div class="container">
    <div class="row d-flex align-items-stretch">
      <div class="col-md-3">
        <h5 class="mb-4">Planes y Servicios</h5>
        <ul class="list-unstyled">
          <li><a href="./servicios/planes/basico.php">Plan básico</a></li>
          <li><a href="#">Plan intermedio</a></li>
          <li><a href="#">Plan avanzado</a></li>
          <li><a href="#">Servicios unitarios</a></li>
        </ul>
      </div>
      <div class="col-md-3">
