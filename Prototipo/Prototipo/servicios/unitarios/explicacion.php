...
<body>
              ...
              <tr>
                ...
                <td>
                  <input type="text" name="cotiza[]" placeholder="0" class="form-control input-sm rounded smaller-input"
                    disabled oninput="validarNumero(this)" pattern="[0-9]+([.,][0-9]+)?" min="1" max="999">
                </td>
                <td>
  ...
  <?php endif; ?>
  <!-- CIERRE DE TABLA DE COTIZACIÓN MADRE-->
    ...
    <div class="contenedor">
      ...
      <div class="overlay" id="overlay">
        <div class="popup container" id="popup">
          ...
          <br>
          <!-- Nueva tabla para mostrar servicios seleccionados -->
          <div class="table-responsive">
            <table class="table">
              <thead>
                <tr>
              ...
              <tbody id="servicios-seleccionados">
              </tbody>
              <tfoot>
                <tr>
                  <td colspan="2" style="text-align: right; font-weight: bold; font-size: 1.3rem;">Cotización
                    Preliminar:</td>
                  <td id="CotizarPopup" style="font-weight: bold; font-size: 1.3rem;">$0.00</td>
                </tr>
              </tfoot>
            </table>
          </div>
